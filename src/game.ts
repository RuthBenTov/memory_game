...
let turnText = document.querySelector(".turnText") as HTMLHeadingElement
let firstSelction: any
let secondSelection: any
let counter = 0
let win = false
let score1 = 0
let score2 = 0
let score1Text = document.querySelector(".score1Text") as HTMLParagraphElement
let score2Text = document.querySelector(".score2Text") as HTMLParagraphElement
let gameMap = document.querySelector(".game .gameMap") as HTMLDivElement
let levels = document.querySelectorAll("input")
let startDiv = document.querySelector(".startGameDiv") as HTMLDivElement
...
function chekCouple(box1: HTMLDivElement, box2: HTMLDivElement) {
